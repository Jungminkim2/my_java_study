...
public class SalaryTest2 {
	...
	public static void main(String[] args) {
		...
		int annualSalaryAfter = annualSalary - annualTax +bonus - bonusTax;
		
		System.out.println("연본 : "+ annualSalary+ ", 세후 연봉 : " + (annualSalary - annualTax));
		System.out.println("보너스 : "+ bonus + ", 세후 보너스 : " + (bonus - bonusTax));
		System.out.println("지급액 : " + annualSalaryAfter);
